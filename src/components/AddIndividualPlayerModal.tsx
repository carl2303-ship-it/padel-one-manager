...
export default function AddIndividualPlayerModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (mode === 'select') {
      ...
      console.log('[PLAYER INSERT - NEW] Attempting to insert player:', insertData);
      console.log('[PLAYER INSERT - NEW] User authenticated:', !!user, 'User ID:', user?.id);
      ...
      console.log('[PLAYER INSERT - EXISTING] Attempting to insert player:', insertData);
      console.log('[PLAYER INSERT - EXISTING] User authenticated:', !!user, 'User ID:', user?.id);
