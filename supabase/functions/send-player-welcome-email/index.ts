...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { email, tournamentName, categoryName } = body;
    ...
    const normalizedPhone = playerAccount.phone_number.replace(/\s+/g, '');
        ...
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <h2 style="margin: 0 0 20px; color: #1f2937; font-size: 22px; font-weight: 600;">Olá ${playerAccount.name}!</h2>
